...
Example calls (use your main language files only):
  ...
  python scripts/luaDoc_generateStr.py LibFurnitureCatalogue/locale/en.lua
  python scripts/luaDoc_generateStr.py LibFurnitureCatalogue/locale/en.lua docs/autocomplete_definitions.lua
  python scripts/luaDoc_generateStr.py LibFurnitureCatalogue/locale/en.lua LibFurnitureCatalogue/locale/de.lua --generate-translation
"""
