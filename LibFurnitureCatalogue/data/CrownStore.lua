...
FurC.CrownStore[ver.WEREWOLF] = {
  [src.CROWN] = {
    ...
    [141856] = strCrate(crates.HOLLOWJACK), -- Decorative Hollowjack Daedra-Skull
    [141855] = strCrate(crates.HOLLOWJACK), -- Decorative Hollowjack Wraith-Lantern
    [141854] = strCrate(crates.HOLLOWJACK), -- Decorative Hollowjack Flame-Skull
    [141870] = strPack(packs.HOLLOWJACK), -- Raven-Perch Cemetery Wreath
    [141875] = strPack(packs.HOLLOWJACK), -- Witches Festival Scarecrow
    [141778] = strPack(packs.HOLLOWJACK), -- Target Wraith-of-Crows
  },
  ...
  [src.EDITOR] = {
    ...
    [141965] = strMultiple(strCrown(240), strPack(packs.HOLLOWJACK)), -- Hollowjack Lantern, Soaring Dragon
    [141966] = strMultiple(strCrown(240), strPack(packs.HOLLOWJACK)), -- Hollowjack Lantern, Toothy Grin
    [141967] = strMultiple(strCrown(240), strPack(packs.HOLLOWJACK)), -- Hollowjack Lantern, Ouroboros
    [142005] = strMultiple(strCrown(180), strPack(packs.HOLLOWJACK)), -- Specimen Jar, Monstrous Remains
    [120876] = strMultiple(strCrown(150), strPack(packs.HOLLOWJACK)), -- Gravestone, Imp Engraving
    [120875] = strMultiple(strCrown(150), strPack(packs.HOLLOWJACK)), -- Gravestone, Clover Engraving
    [142003] = strMultiple(strCrown(180), strPack(packs.HOLLOWJACK), getHouseString(11687)), -- Specimen Jar, Eyes
...
FurC.CrownStore[ver.DRAGONS] = {
  ...
  [src.EDITOR] = {
    ...
    [139157] = strMultiple(strCrown(90), strPack(packs.MEPHALA), strPack(packs.HOLLOWJACK)), -- Webs, Thick Sheet
    [141939] = strMultiple(strCrown(180), strPack(packs.HOLLOWJACK)), -- Grave, Grasping
  },
}
...
FurC.CrownStore[ver.HOMESTEAD] = {
  ...
  [src.EDITOR] = {
    ...
    [118143] = strMultiple(strCrown(410), mischouse), -- Painting of Tree, Refined
    [118141] = strMultiple(strCrown(410), mischouse), -- Painting of Cottage, Refined
    [118139] = strMultiple(strCrown(410), mischouse), -- Painting of Valley, Refined
  },
}
